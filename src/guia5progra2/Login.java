...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jlblBienvenido.setFont(new java.awt.Font("Zack Thin", 1, 48)); // NOI18N
        ...
        jlblUsuario.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        jlblUsuario.setForeground(new java.awt.Color(255, 255, 255));
        jlblUsuario.setText("Usuario:");
        jPanel1.add(jlblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 100, 70));

        jlblContraseña.setBackground(new java.awt.Color(255, 255, 255));
        jlblContraseña.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        jlblContraseña.setForeground(new java.awt.Color(255, 255, 255));
        jlblContraseña.setText("Contraseña:");
        jPanel1.add(jlblContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 370, 110, 60));

        jtxtUsuario.setBackground(new java.awt.Color(16, 16, 16));
        jtxtUsuario.setFont(new java.awt.Font("Eras Medium ITC", 0, 24)); // NOI18N
        ...
        jPassword.setFont(new java.awt.Font("Dubai Medium", 0, 18)); // NOI18N
        ...
        jlblIniciarSesion.setFont(new java.awt.Font("Dubai Light", 1, 18)); // NOI18N
